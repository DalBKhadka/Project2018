...
<div class="container my-3">
    <div class="row">
        <div class="col-md-9 mx-auto">
            ...
            <fieldset><legend class="mb-0 text-center font-weight-bold">Patient Registration</legend>
            ...
            <div class="req" id="postcodeErr"><?php echo $postcodeErr;?></div>
                ...
                <input class="form-control"  type="email" name="email" id = "email" placeholder="Email Address" onchange="email_validate(this.value);" />   
                    <!--     <div class="status" id="status"></div> -->
                <!-- <div class="req" id="emailErr"><?php echo $emailErr;?></div>  -->
            ...
            <!-- <div class="req" id="workPhoneErr"><?php echo $workPhoneErr;?></div> -->
                ...
                <hr class="my-0">
                <legend class="text-center font-weight-normal">Health Fund Details</legend>
                <hr class="mt-0 mb-1">
            <div class="form-group d-inline-block  col-lg-4">
            <label for="healthFundMembershipNumber"><span class="req">* </span>Membership Number: </label><input required type="text" name="healthFundMembershipNumber" id="healthFundMembershipNumber" class="form-control" maxlength="20" onkeyup="validatephone(this);" placeholder="Health Fund Membership Number"/>
            <div class="req" id="healthFundMembershipNumberErr"><?php echo $healthFundMembershipNumberErr;?></div>

            </div><div class="form-group d-inline-block  col-lg-4">
            <label for="fundName"><span class="req">* </span> Health Fund: </label><input required type="text" name="fundName" id="fundName" class="form-control" onkeyup="validatephone(this);" placeholder="Fund Name"/>
            <div class="req" id="fundNameErr"><?php echo $fundNameErr;?></div>

            </div><div class="form-group d-inline-block  col-lg-4">
            <label for="dateJoined"><span class="req">* </span> Date Joined: </label><input required type="date" name="dateJoined" id="dateJoined" class="form-control" onkeyup="validatephone(this);" placeholder="Date Joined"/>
            <div class="req" id="dateJoinedErr"><?php echo $dateJoinedErr;?></div>

            </div><div class="form-group d-inline-block  col-lg-4">
                <label for="status"><span class="req">* </span> Status: </label><select class="form-control" name="state" id="state" required>
                ...
                <!-- Medicare Details -->
            <hr class="my-0">
                <legend class="text-center font-weight-normal">Medicare Details</legend>
                <hr class="mt-0 mb-1">
            <div class="form-group d-inline-block  col-lg-4">
                <label for="medicareNumber"><span class="req">* </span> Medicare Number: </label><input required type="number" name="medicareNumber" id="medicareNumber" class="form-control" maxlength="20" onkeyup="validatephone(this);" placeholder="Medicare Number"/>
                <div class="req" id="medicareNumberErr"><?php echo $medicareNumberErr;?></div>

            </div><div class="form-group d-inline-block  col-lg-4">
            <label for="individualNo"><span class="req">* </span> Individual No: </label><input required type="number" name="individualNo" id="individualNo" maxlength="1" class="form-control" onkeyup="validatephone(this);" placeholder="Individual No"/>
            <div class="req" id="individualNoErr"><?php echo $individualNoErr;?></div> 

            </div><div class="form-group d-inline-block  col-lg-4">
            <label for="expiryDate"><span class="req">* </span> Expiry Date: </label><input required type="date" name="expiryDate" id="expiryDate" class="form-control" onkeyup="validatephone(this);" placeholder="Expiry Date"/>
            <div class="req" id="expiryDateErr"><?php echo $expiryDateErr;?></div> 
